      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
        {stations.map((s) => (
          <button
            ...
            className="text-left px-3 py-2 rounded-lg bg-gray-900 hover:bg-gray-800 border border-gray-800 hover:border-gray-600 transition-colors text-sm truncate"
          >
            {s.name}
          </button>
        ))}
